...
#include"Colosseum.h"
    ...
    */
    StatusType
    BuyGladiator(void *DS, int gladiatorID, int trainerID, int level) {
    ...
    */
    StatusType
    GetAllGladiatorsByLevel(void *DS, int trainerID, int **gladiators,
                            int *numOfGladiator) {
        if (!DS || !trainerID || !gladiators || !numOfGladiator)
            return INVALID_INPUT;
        return ((Colosseum *) DS)->GetAllGladiatorsByLevel(trainerID,
                                                           gladiators,
                                                           numOfGladiator);
    }
